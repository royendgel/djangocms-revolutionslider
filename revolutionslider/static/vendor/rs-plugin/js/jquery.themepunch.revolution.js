 ...
 * @version: 4.6.4-1 (18.9.2015)
 * Adapted by Urga Creatieve communicatie to work with django-cms (replacing ul by div elements)
 * contact: dries@urga.be
...
(function(jQuery,undefined){
	...
	jQuery.fn.extend({
		...
		revscroll: function(oy) {
					return this.each(function() {
						...
						if (container!=undefined && container.length>0 && jQuery('body').find('#'+container.attr('id')).length>0)
							jQuery('body,html').animate({scrollTop:(container.offset().top+(container.find('.slides .slide').height())-oy)+"px"},{duration:400});
					})
				},
		...
		revmaxslide: function(options) {
						// CATCH THE CONTAINER
						return jQuery(this).find('.slides:first-child .slide').length;
				},
		...
		function initSlider(container,opt) {
						...
						if (opt.simplifyAll=="on" && (isIE(8) || iOSVersion())) {
							...
							container.find('.slide').each(function() {
								...
								slide.data('masterspeed',500);
								slide.data('slotamount',1);
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									container.find('.slides:first-child .slide').each(function() {
											var t = jQuery(this);
									...
									if (opt.shuffle=="on") {
										var fsa = new Object,
											fli = container.find('.slides:first-child .slide:first-child')
										...
										for (var u=0;u<container.find('.slides:first-child .slide').length;u++) {
											var it = Math.round(Math.random()*container.find('.slides:first-child .slide').length);
											container.find('.slides:first-child .slide:eq('+it+')').prependTo(container.find('.slides:first-child'));
										}

										var newfli = container.find('.slides:first-child .slide:first-child');
									...
									if (deeplink.length<9) {
										if (deeplink.split('slide').length>1) {
											...
											if (dslide>container.find('.slides:first .slide').length) dslide=container.find('.slides:first .slide').length;
											opt.next=dslide-1;
										}
									}
									...
									opt.slideamount = container.find('.slides:first .slide').length;
									...
									container.find('.slides').css({'display':'none'});

									var fliparent = container;


									// PREPARE THE SLIDES
									container.find('.slides').css({'display':'block'});
									...
									//if (opt.fullScreen=="on") {
										container.find('.tp-scrollbelowslider').on('click',function() {
												...
												jQuery('body,html').animate(
													{scrollTop:(container.offset().top+(container.find('.slides .slide').height())-off)+"px"},{duration:400});
											});
									//}
...
********************************/
		...
		var containerResized = function (container,opt) {
			...
			var actsh = container.find('.slides .slide:eq('+opt.act+') .slotholder');
			var nextsh = container.find('.slides .slide:eq('+opt.next+') .slotholder');
			...
			var nextli = container.find('.slides .slide:eq('+opt.next+')');
		...
		********************************/
		...
		var callingNewSlide = function(opt,container) {
						// CHECK THE LOOPS !!
						if (opt.next==container.find('.slides .slide').length-1) {
		...
		var createBullets = function(container,opt) {
			...
			container.find('.slides:first .slide').each(function(i) {
							var src=container.find(".slides:first .slide:eq("+i+") img:first").attr('src');
		...
		*******************************************************/
		...
		var handleSpecialPreviews = function(opt) {
			...
			var comingli = container.find('.slides:first-child .slide:eq('+opt.comingli+')'),
				beforli = container.find('.slides:first-child .slide:eq('+opt.beforli+')'),
		...
		var prepareSlides = function(container,opt) {
			...
			container.find('.slides:first').css({overflow:'hidden',width:'100%',height:'100%',maxHeight:container.parent().css('maxHeight')}).addClass("tp-revslider-mainul");
			if (opt.autoHeight=="on") {
			   container.find('.slides:first').css({overflow:'hidden',width:'100%',height:'100%',maxHeight:"none"});
			   container.css({'maxHeight':'none'});
			   container.parent().css({'maxHeight':'none'});
			 }

			container.find('.slides:first .slide').each(function(j) {
				var li=jQuery(this);
			...
			container.find('.slides:first .slide >img').each(function(j) {
		...
		********************************************/
		...
		var swapSlide = function(container,opt) {
				...
				try{
					var actli =container.find('.slides:first-child .slide:eq('+opt.act+')');
				} catch(e) {
					var actli=container.find('.slides:first-child .slide:eq(1)');
				}
				opt.lastslide=opt.act;
				var nextli = container.find('.slides:first-child .slide:eq('+opt.next+')');
...
**************************************************************************/
		...
		**************************************************************************/
		...
		var createThumbs = function(container,opt) {
			...
			container.find('.slides:first .slide').each(function(i) {
							var li= container.find(".slides:first .slide:eq("+i+")");
			...
			var max=minwidth*container.find('.slides:first .slide').length;
			...
			if (thumbconwidth<max) {
				...
				bullets.parent().mouseenter(function() {
						...
						var offset = $this.offset(),
							...
							max=minwidth*container.find('.slides:first .slide').length,
				...
				bullets.parent().mousemove(function() {
								...
								var $this=jQuery(this),
									...
									thumbconwidth=$this.width(),
									minwidth=$this.find('.bullet:first').outerWidth(true),
									max=minwidth*container.find('.slides:first .slide').length-1,
									diff=(max- thumbconwidth)+15,
									steps = diff / thumbconwidth;
